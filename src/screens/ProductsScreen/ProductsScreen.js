  ...
  useEffect(() => {
    const filteredProducts = products.filter((product) => {
      ...
      const nameFilterPassed =
        ...
        // console.log("priceFilterPassed ", priceFilterPassed);
        // console.log("ratingFilterPassed ", ratingFilterPassed);
        // console.log("nameFilterPassed ", nameFilterPassed);
        ...
        <Col md="9">
          <Row>
            {!filteredProducts.length ? (
              <h1 style = {{color : "white"}}>No such product found</h1>
            ) : (
